...
/** Pedestal / cart / freestanding — grill + smoker. */
export const FREESTANDING_IMAGES = [
  {
...
export const DEEP_CLEAN_FEATURES = [
  {
...
/**
 * Shared pricing offerings — used by /pricing and the homepage lander
 * so details and style stay identical.
 */
export function PricingOfferings({
  sectionHeading: SectionHeading = "h2",
}: {
  /** Section titles (deep clean, semi-annual, more ways, repairs). Home uses h3 under the lander h2. */
        ...
        <div className="pricing-page-inner">
          <article className="price-feature-card">
            <div className="price-feature-top">
              <div>
                <SectionHeading id="deep-clean-heading">
                  One-Time Deep Clean
                </SectionHeading>
        ...
        <div className="pricing-page-inner">
          <div className="plan-strip">
            <div className="plan-strip-main">
              ...
              <SectionHeading id="semi-annual-heading">Semi-Annual Care</SectionHeading>
              <p>
            ...
            <div className="plan-strip-perks">
              <h3 className="plan-strip-perks-title">Plan perks</h3>
              <ul>
                <li>
      ...
      <section className="pricing-secondary" aria-labelledby="more-services-heading">
        <div className="pricing-page-inner">
          <div className="pricing-secondary-header">
            ...
            <SectionHeading id="more-services-heading">More Ways We Help</SectionHeading>
            <p>
        ...
        <div className="pricing-page-inner">
          <div className="repairs-card pricing-repairs-card">
            <div className="repairs-header">
              ...
              <SectionHeading id="repairs-heading">Grill Repair Services</SectionHeading>
              <p>
